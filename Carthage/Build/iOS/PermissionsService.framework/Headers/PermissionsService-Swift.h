...
SWIFT_MODULE_NAMESPACE_PUSH("PermissionsService")
...
SWIFT_CLASS("_TtC18PermissionsService8Location")
...
@interface Location (SWIFT_EXTENSION(PermissionsService)) <CLLocationManagerDelegate>
- (void)locationManager:(CLLocationManager * _Nonnull)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status;
@end


/// Result for a permission status request.
SWIFT_CLASS("_TtC18PermissionsService16PermissionResult")
